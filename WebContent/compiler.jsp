...
%></a>
            <ul>
              ...
              <li><a href="code.jsp">View Codes</a></li>
          ...
          <div class="about-text">
			<form name="form">
				...
				Enter Your Class Name
                  <input type="text" name="class" id="class" placeholder="Your ClassName" onblur="set()" />
                </div>
                <div class="form-group">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
				<textarea cols="70" rows="15" name="code1" id="code1" disabled="disabled"></textarea>
				</div>
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                  <input type="button" class="form-control" value="SAVE" onclick="" />
                </div>
                </div>               
			</form>
          </div>
